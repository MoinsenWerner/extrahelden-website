...
<section class="row">
  <div class="card" style="min-height:250px; min-width:50%">
    <h2>Neuigkeiten</h2>
    <?php if (empty($posts)): ?>
...
(function(){
  ...
  // --- NEU: Passkey-Funktionen in index.php verfügbar machen ---
...
// --- Ende Passkey-Funktionen ---
})();
</script>
<?php 
// --- NEU: Der Trigger für die Abfrage ---
if (!empty($_SESSION['ask_for_passkey'])): ?>
    <script>
        // Kleiner Timeout, damit der User nicht sofort beim Laden "erschlagen" wird
        setTimeout(() => {
//            if (confirm("Möchten Sie dieses Gerät mit einem Passkey verknüpfen, um sich künftig schneller anzumelden?")) {
//                registerPasskey();
//            }
              const placeholdervar = "xy";
        }, 500);
    </script>
    <?php unset($_SESSION['ask_for_passkey']); ?>
<?php endif; ?>
